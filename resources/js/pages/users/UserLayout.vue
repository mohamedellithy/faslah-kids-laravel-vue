                    ...
                    <ul class="navbar-nav mr-auto items-mobile">
                        ...
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                                <img :src="[this.$store.getters['auth/Authenticated'].image.length != 0 ? this.$store.getters['auth/Authenticated'].image.image_url : require('../../assets/img/theme/sketch.jpg')]" />
                            </a>
                        ...
                        <ul class="navbar-nav ml-auto">
                            <!-- Authentication Links -->
                                ...
                                <li class="nav-item dropdown">
                                    <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                                        <img :src="[this.$store.getters['auth/Authenticated'].image.length != 0 ? this.$store.getters['auth/Authenticated'].image.image_url : require('../../assets/img/theme/sketch.jpg')]" />
                                        <label>{{ $store.getters['auth/Authenticated'].fullname }}</label>
                                    </a>
