    ...
    <side-bar>
      <template slot="links">
        ...
        <sidebar-item
            ...
            >
            <sidebar-item
              :link="{ name: 'show Products', path: this.$root.adminUrl + '/products/' }" exact
            ></sidebar-item>

            <sidebar-item
                :link="{ name: 'create Product', path: this.$root.adminUrl + '/products/create/' }" exact
            ></sidebar-item>
        ...
        <sidebar-item
              :link="{
                ...
                <sidebar-item
                    :link="{ name: 'show solutions', path: this.$root.adminUrl + '/solutions/' }"
                ></sidebar-item>
