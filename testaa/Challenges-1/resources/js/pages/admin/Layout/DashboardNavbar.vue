      ...
      <base-dropdown menu-on-right
        ...
        <a href="#" class="nav-link pr-0" @click.prevent slot="title-container">
          <b-media no-body class="align-items-center">
            ...
            <b-media-body class="ml-2 d-none d-lg-block">
              <span class="mb-0 text-sm  font-weight-bold">{{ `${this.$store.state.auth.user.firstname} ${this.$store.state.auth.user.lastname} `  }}</span>
            </b-media-body>
          </b-media>
        </a>
        ...
        <template>
          ...
          <li role="presentation">
            <a role="menuitem" class="dropdown-item" @click="logout_user">
