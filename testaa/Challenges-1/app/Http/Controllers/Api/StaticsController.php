...
class StaticsController extends Controller
{
    ...
    public function barcodesStatics(){
       ...
       $this->Context['part_3']['count']              = Barcode::whereHas('challenges')->count();
    ...
    public function challengesStatics(){
       ...
       $this->Context['part_2']['count']              = Challenge::whereHas('barcode')->count();
       $this->Context['part_2']['title']              = 'barcodes_activated';
